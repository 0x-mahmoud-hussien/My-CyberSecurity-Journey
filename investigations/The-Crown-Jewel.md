...
* **Platform:** TryHackMe  
* **Room:** The Crown Jewel  
* **Category:** Network Forensics / SIEM / Incident Response  
* **Difficulty:** Easy  
* **Analyst:** Mahmoud Hussien 
* **Client:** Imperium Labs  
* **Tools:** Wireshark, Splunk (`index=network_logs`)  
* **Artefacts:** `challenge.pcap` + Pre-ingested Splunk logs  
* **Alert:** Reverse Shell Outbound Connection Detected

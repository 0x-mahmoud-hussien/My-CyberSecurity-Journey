...
* **Platform:** TryHackMe  
* **Room:** Zero Tolerance  
* **Category:** DFIR / SIEM / Endpoint Forensics  
* **Difficulty:** Hard  
* **Analyst:** Mahmoud Hussien 
* **Client:** VaultSecure Banking (via ProbablyFine Ltd.)  
* **Tools:** Splunk + KAPE Triage Collection  
* **Alert:** CRITICAL: Suspicious Persistence Mechanism Detected

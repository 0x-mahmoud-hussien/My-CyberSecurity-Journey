...
* **Platform:** HackTheBox  
* **Challenge Type:** Sherlock (DFIR)  
* **Category:** Network Forensics / Active Directory  
* **Difficulty:** Easy  
* **Analyst:** Mahmoud Hussien
* **Tools:** Wireshark  
* **Artefacts:** PCAP + Windows Event Logs  
* **Attack Vector:** NTLM Relay / Credential Interception

...
- **Terminal Command Line:** Navigating the file system using `cd`, `ls`, `pwd`.
...
#### 10. Detecting Web Attacks
<p align="center">
  <img src="./images/detecting_web_attacks_badge.png" width="45%" />
  <img src="./images/detecting_web_attacks_tasks.png" width="45%" />
</p>

* **ما تم تعلمه (Learning Objectives):**
    * التعرف على أنواع هجمات الويب الشائعة التي تستهدف المستخدم (Client-side) والسيرفر (Server-side).
    * فهم مميزات وعيوب طرق الاكتشاف القائمة على تحليل السجلات (Log-based Detection).
    * استكشاف أساليب رصد الهجمات من خلال تحليل حركة مرور الشبكة (Network Traffic Analysis).
    * دراسة دور وأهمية جدران حماية تطبيقات الويب (WAF) في صد الهجمات.
    * الممارسة العملية على كشف وتحديد هجمات الويب الحقيقية باستخدام الأدوات والأساليب المذكورة.



---

#### 11. Detecting Web Shells
<p align="center">
  <img src="./images/detecting_web_shells_badge.png" width="45%" />
  <img src="./images/detecting_web_shells_tasks.png" width="45%" />
</p>

* **ما تم تعلمه (Learning Objectives):**
    * فهم ماهية الـ **Web Shells** وكيفية استخدام المهاجمين لها للسيطرة على السيرفرات عن بعد.
    * تعلم تقنيات اكتشاف نشاط الـ Web Shell من خلال تحليل السجلات (Logs)، ونظام الملفات (File System)، والشبكة.
    * التعرف على الأدوات والأساليب الشائعة المستخدمة في رصد وكشف الـ Web Shells بمختلف أنواعها.
...
#### 12. Detecting Web DDoS
<p align="center">
  <img src="./images/web_ddos_tasks.png" width="45%" />
</p>

* **ما تم تعلمه (Learning Objectives):**
    * فهم كيفية عمل هجمات حجب الخدمة (DoS) وآليات تعطيلها للأنظمة.
    * استيعاب دوافع المهاجمين من القيام بهذه الهجمات التخريبية.
    * كشف علامات الـ **Web DoS** والـ **DDoS** من خلال تحليل سجلات الويب (Web Logs).
    * التدريب العملي على تحليل هجمات حجب الخدمة باستخدام تحليل السجلات (Log Analysis).
    * استكشاف تقنيات الكشف والحد من المخاطر (Detection & Mitigation) التي يستخدمها المدافعون.

---

### 🏆 Special Achievement: Web Defender
<p align="center">
  <img src="./images/web_defender_badge.png" width="30%" />
</p>

> **تم الحصول على هذه البادج بعد إتمام سلسلة غرف تأمين واكتشاف هجمات الويب بنجاح.**
...
* **السيناريو والتحقيق (Scenario & Investigation):**
    * محاكاة دور محلل SOC (Analyst John) للتحقيق في تنبيه IDS يشير لاتصال **C2** مشبوه من قسم الـ HR.
    * تحليل سجلات **HTTP** لمدة أسبوع كامل تم سحبها وفهرستها داخل **Kibana** (index: connection_logs).
...
* **التحقيق والسيناريو (Scenario & Investigation):**
    * التحقيق في تنبيه أمني يشير لتعرض مستخدم لمشكلة بسبب "فضوله" في تصفح فهرس ملفات مشبوه (Poor file index).
    * استخدام **TShark** لتحليل ملف الـ PCAP واستخراج الأدلة الرقمية (Artifacts) من حركة مرور الشبكة.
    * استخراج الـ **Hashes** للملفات المشبوهة وفحصها باستخدام **VirusTotal** لتأكيد الإصابة (True Positive).
* **المهارات المكتسبة (Skills Applied):**
